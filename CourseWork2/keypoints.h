...
namespace cw
{
  class keypoints
  {
    ...
    static std::vector<cv::DMatch> getAllFirstBestMatches(const cv::Mat& descriptor1, const cv::Mat& descriptor2);
    static std::vector<cv::DMatch> getAllKFirstBestMatches(const cv::Mat& descriptor1, const cv::Mat& descriptor2, int k);
    static std::vector<cv::DMatch> getGoodMatches(const cv::Mat& descriptor1, const cv::Mat& descriptor2);
  public:
    ...
    static std::vector<std::pair<cloud2d, cloud2d>> oldGoodDescriptorFilter(const std::vector<keypoints>& keypointsList);
    static std::vector<std::pair<cloud2d, cloud2d>> oldFirstDescriptorFilter(const std::vector<keypoints>& keypointsList);
